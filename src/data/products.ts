...
export const PRODUCTS: Product[] = [
  ...
  { id: 'p10b', name: 'Táo xanh Ninh Thuận', provinceKey: 'vn-nt', price: 45000, unit: 'kg', emoji: '🍏', producer: 'Nông trại Ninh Hải', tags: ['Trái cây'] },
  { id: 'p10c', name: 'Thanh long Ninh Thuận', provinceKey: 'vn-nt', price: 32000, unit: 'kg', emoji: '🐉', producer: 'HTX Thanh long Ninh Thuận', tags: ['Trái cây'] },
  { id: 'p10d', name: 'Mãng cầu ta', provinceKey: 'vn-nt', price: 40000, unit: 'kg', emoji: '🟢', producer: 'Nông hộ Ninh Thuận', tags: ['Trái cây'] },
  { id: 'p10e', name: 'Chuối Ninh Thuận', provinceKey: 'vn-nt', price: 15000, unit: 'kg', emoji: '🍌', producer: 'Nông hộ Ninh Thuận', tags: ['Trái cây'] },
  { id: 'p10f', name: 'Xoài Ninh Thuận', provinceKey: 'vn-nt', price: 35000, unit: 'kg', emoji: '🥭', producer: 'Nông hộ Ninh Thuận', tags: ['Trái cây'] },
  { id: 'p10g', name: 'Mủ trôm', provinceKey: 'vn-nt', price: 200000, unit: 'kg', emoji: '🌿', producer: 'Nông hộ Ninh Thuận', tags: ['Đặc sản'] },
  { id: 'p10h', name: 'Hạt đười ươi bay', provinceKey: 'vn-nt', price: 300000, unit: 'kg', emoji: '🌰', producer: 'Nông hộ Ninh Thuận', tags: ['Dược liệu'] },
  { id: 'p10i', name: 'Trái xay nhung rừng', provinceKey: 'vn-nt', price: 150000, unit: 'kg', emoji: '🍈', producer: 'Nông hộ Ninh Thuận', tags: ['Trái cây', 'Đặc sản'] },
  { id: 'p10j', name: 'Trái da đá', provinceKey: 'vn-nt', price: 50000, unit: 'kg', emoji: '🍐', producer: 'Nông hộ Ninh Thuận', tags: ['Trái cây'] },
  { id: 'p10k', name: 'Tỏi Phan Rang', provinceKey: 'vn-nt', price: 80000, unit: 'kg', emoji: '🧄', producer: 'Nông hộ Phan Rang', tags: ['Gia vị', 'OCOP'], certified: true },
  { id: 'p10l', name: 'Măng tây xanh Ninh Thuận', provinceKey: 'vn-nt', price: 120000, unit: 'kg', emoji: '🌱', producer: 'HTX Măng tây Ninh Thuận', tags: ['Rau củ', 'OCOP'], certified: true },
