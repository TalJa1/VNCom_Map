...
export const PRODUCTS: Product[] = [
  ...
  { id: 'p10-f2', name: 'Nho Ninh Thuận', provinceKey: 'vn-nt', price: 60000, unit: 'kg', emoji: '🍇', producer: 'Nông hộ Anh Hoàng', tags: ['Trái cây', 'VietGAP'], certified: true, images: [] },
  { id: 'p10-f9', name: 'Nho Mẫu Đơn & Nho sữa Hàn Quốc', provinceKey: 'vn-nt', price: 80000, unit: 'kg', emoji: '🍇', producer: 'Nông hộ Chị Trâm', tags: ['Trái cây', 'Giống đặc biệt'], images: [] },
  { id: 'p10b-f1', name: 'Táo xanh Ninh Thuận', provinceKey: 'vn-nt', price: 45000, unit: 'kg', emoji: '🍏', producer: 'Chang Chang Farm', tags: ['Trái cây', '35 năm truyền thống'], images: [] },
  { id: 'p10b-f4', name: 'Táo xanh Ninh Thuận', provinceKey: 'vn-nt', price: 45000, unit: 'kg', emoji: '🍏', producer: 'Hộ trồng táo Cô Như', tags: ['Trái cây', '5 năm kinh nghiệm'], images: [] },
  { id: 'p10b-f5', name: 'Táo xanh Ninh Thuận', provinceKey: 'vn-nt', price: 45000, unit: 'kg', emoji: '🍏', producer: 'Nông hộ Chú Tín', tags: ['Trái cây', '3 năm kinh nghiệm'], images: [] },
  ...
  { id: 'p10l', name: 'Măng tây xanh Ninh Thuận', provinceKey: 'vn-nt', price: 120000, unit: 'kg', emoji: '🌱', producer: 'Nông hộ Cô Xéo', tags: ['Rau củ', 'OCOP', 'Tuần hoàn'], certified: true, images: [] },
  { id: 'p10m', name: 'Chanh dây Ninh Thuận', provinceKey: 'vn-nt', price: 35000, unit: 'kg', emoji: '🟡', producer: 'Nông hộ Anh Mân', tags: ['Trái cây'], images: [] },
  { id: 'p10n', name: 'Đậu phộng Ninh Thuận', provinceKey: 'vn-nt', price: 50000, unit: 'kg', emoji: '🥜', producer: 'Nông hộ Kiều Văn Toản', tags: ['Nông sản', 'Hữu cơ'], images: [] },
  { id: 'p10o', name: 'Dừa Ninh Thuận', provinceKey: 'vn-nt', price: 20000, unit: 'quả', emoji: '🥥', producer: 'Nông hộ Anh Tứ', tags: ['Trái cây'], images: [] },
